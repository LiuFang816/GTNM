...
class localContext(object):
    ...
    def process_one_file(self, data):
        ...
        # ext_sample, ext_tag = self.process_functions(data, encoded_import_context+encoded_file_level_context)
        ...
        for clazz in data["schema"]["classes"]:
            ...
            #     # print('---')
            #     for import_context in data["imports"]:
            #         print(import_context.keys())
            #         # if "definition" in import_context:   
            #         #     print(import_context["definition"] + '\n', file=out)
            #         if "methods" in import_context:   
            #             for m in import_context["methods"]:
            #                 print(m['name'])
    

            #     print('===')
            #     #print(data["schema"]["classes"])
            #     # print('===', file=out)
            #     # out.flush()
...
def parse_args():
    ...
    parser.add_argument(
        "--input_file_name",
        type=str, 
        default="/data4/liufang/GTNM/raw/train_all1.pkl",
        help="Input file name",
    )
    parser.add_argument(
        "--output_file_name",
        type=str,
        default="/data4/liufang/GTNM/train_subword1",
